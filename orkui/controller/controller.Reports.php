...
class Controller_Reports extends Controller
{
    ...
    public function parkheraldry($kingdom_id = null)
    {
    ...
    public function kingdomheraldry($request = null)
    {
        $this->template = 'Reports_heraldry.tpl';
    ...
    public function unitheraldry($request = null)
    {
        $this->template = 'Reports_heraldry.tpl';
    ...
    {
        $this->_test_results($type, 'reeve', "Reeve's Test", 'fa-gavel', "Reeve's Test Results");
    }

    public function corpora_test_results($type = null)
    {
        $this->_test_results($type, 'corpora', 'Corpora Test', 'fa-book', 'Corpora Test Results');
    }
